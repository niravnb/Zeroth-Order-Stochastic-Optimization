...
for N = NList
   ...
   if step == 0
    ...
    ub(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
...
plot(NList,ub(:,2));
save(['RSQN_multimodal_ub_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'ub','-ascii')
...
for N = NList
    ...
    gs(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
disp(gs(:,2:3));
 disp('--------------------------------End GS----------------------------------');
...
plot(NList,gs(:,2));
save(['RSQN_multimodal_gs_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'gs','-ascii')
...
for N = NList
    ...
    spsa(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
disp(spsa(:,2:3));
 disp('--------------------------------End 1SPSA----------------------------------');
...
plot(NList,spsa(:,2));
save(['RSQN_multimodal_spsa_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'spsa','-ascii')
...
%     str=sprintf('N = %d \n', N); disp(str);
    ...
    rdsa_u(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
disp(rdsa_u(:,2:3));
 disp('--------------------------------End 1RDSA_Uniform----------------------------------');
plot(NList,rdsa_u(:,2));
save(['RSQN_multimodal_rdsa_u_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'rdsa_u','-ascii')
...
%    Setting step size, Probability mass function and eta
    ...
    rdsa_ab(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
 disp(rdsa_ab(:,2:3));
 disp(' -------------------------------End 1RDSA_Asymber----------------------------------');
plot(NList,rdsa_ab(:,2));
save(['RSQN_multimodal_rdsa_ab_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'rdsa_ab','-ascii')
...
for N = NList
    ...
    rdsa_perm(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
    i = i+1;
end
 disp(rdsa_perm(:,2:3));
 disp('--------------------------------End 1RDSA_Perm_DP----------------------------------');
% plot(NList,rdsa_perm(:,2));
save(['RSQN_multimodal_rdsa_perm_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'rdsa_perm','-ascii')
...
%     P_R = gamma./sum(gamma);
%     
%     rdsa_lex(i,2:7) = rsqn(d, type, algo, N, T, Q, x_1, x_star, gamma, P_R, eta, sigma);
%     i = i+1;
% end
%  disp(rdsa_lex(:,2));
%  disp('--------------------------------End 1RDSA_Lex_DP----------------------------------');
% plot(NList,rdsa_lex(:,2));
% save(['RSQN_multimodal_rdsa_lex_dim_',num2str(d),'_x1_',num2str(initial),'.txt'],'rdsa_lex','-ascii')
...
save(['rsqn_multimodal_dim_',num2str(d),'_x1_',num2str(initial)]);
