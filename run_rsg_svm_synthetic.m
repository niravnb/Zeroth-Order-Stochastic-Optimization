...
d = 500; % Dimension of the problem
step = 2; % Setting type of stepsize; value of 0 mean min{1/L, 1/(d^2N)^2/3}, 1 means min{1/L, c/sqrt(N)}, 2 means 1\L, 3 means 1\LK with eta = 1
...
alpha_1 = (2 + lambda*d*1^2)^2; % Estimate of E[f(x + eta*delta)^2] upper bound
...
save(['synthetic_dataset_d',num2str(d)]);

%% Loading dataset and parameter
% load(['synthetic_d',num2str(d)]);
...
plot(NList,ub(:,2));
save(['svm_synthetic_ub_dim_',num2str(d),'_step_',num2str(step),'.txt'],'ub','-ascii')
...
plot(NList,gs(:,2));
save(['svm_synthetic_gs_dim_',num2str(d),'_step_',num2str(step),'.txt'],'gs','-ascii')
...
plot(NList,spsa(:,2));
save(['svm_synthetic_spsa_dim_',num2str(d),'_step_',num2str(step),'.txt'],'spsa','-ascii')
...
plot(NList,rdsa_u(:,2));
save(['svm_synthetic_rdsa_u_dim_',num2str(d),'_step_',num2str(step),'.txt'],'rdsa_u','-ascii')
...
save(['svm_synthetic_rdsa_ab_dim_',num2str(d),'_step_',num2str(step),'.txt'],'rdsa_ab','-ascii')
...
save(['svm_synthetic_rdsa_perm_dim_',num2str(d),'_step_',num2str(step),'.txt'],'rdsa_perm','-ascii')
...
save(['svm_synthetic_rdsa_kw_dim_',num2str(d),'_step_',num2str(step),'.txt'],'rdsa_kw','-ascii')
...
% save(['svm_synthetic_rdsa_lex_dim_',num2str(d),'.txt'],'rdsa_lex','-ascii')
...
save(['svm_synthetic_d',num2str(d),'_step_',num2str(step)]);
