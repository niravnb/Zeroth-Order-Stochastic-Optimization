...
plot(NList,ub(:,2));
save(['RSQN_svm_bank_ub_x1_',num2str(initial),'.txt'],'ub','-ascii')
...
plot(NList,gs(:,2));
save(['RSQN_svm_bank_gs_x1_',num2str(initial),'.txt'],'gs','-ascii')
...
plot(NList,spsa(:,2));
save(['RSQN_svm_bank_spsa_x1_',num2str(initial),'.txt'],'spsa','-ascii')
...
plot(NList,rdsa_u(:,2));
save(['RSQN_svm_bank_rdsa_u_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_u','-ascii')
...
save(['RSQN_svm_bank_rdsa_ab_x1_',num2str(initial),'.txt'],'rdsa_ab','-ascii')
...
for N = NList
    ...
    elseif step == 2
       gamma = ones(N,1).*(2*C_l + 2*c_11*eta(1)^2 - 1)/L;
    elseif step == 3
       gamma = (2*C_l + 2*c_11*eta(1)^2 - 1)/L.*1./(1:N); % Decreasing step size 
       eta = ones(N,1);
    end
...
save(['RSQN_svm_bank_rdsa_perm_x1_',num2str(initial),'.txt'],'rdsa_perm','-ascii')
...
% save(['RSQN_svm_bank_rdsa_lex_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_lex','-ascii')
...
save(['RSQN_svm_bank_step_',num2str(step),'_x1_',num2str(initial)]);
