...
N_0 = 150; % Using N_0 i.i.d. samples 
approx_samples = 150;
...
plot(NList,ub(:,2));
save(['svm_heart_ub_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'ub','-ascii')
...
plot(NList,gs(:,2));
save(['svm_heart_gs_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'gs','-ascii')
...
plot(NList,spsa(:,2));
save(['svm_heart_spsa_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'spsa','-ascii')
...
plot(NList,rdsa_u(:,2));
save(['svm_heart_rdsa_u_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_u','-ascii')
...
save(['svm_heart_rdsa_ab_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_ab','-ascii')
...
save(['svm_heart_rdsa_perm_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_perm','-ascii')
...
save(['svm_heart_rdsa_kw_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_kw','-ascii')
...
% save(['svm_heart_rdsa_lex_step_',num2str(step),'_x1_',num2str(initial),'.txt'],'rdsa_kw','-ascii')
...
save(['svm_heart_step_',num2str(step),'_x1_',num2str(initial)]);
